...
// Радио дуудлагын (жиш нь Morse Runner) хэвшлээр санамсаргүй тэмдэгтийг
// groupSize-аар бүлэглэж, зайгаар тусгаарлана ("K3XQP N8ZRT" гэх мэт).
// textToMorse нь зайг "/" (7 нэгжийн чимээгүй завсар) болгодог тул бүлэг
// хоорондоо стандарт радио завсартайгаар тоглогдоно.
export function randomGroupedChars(groupCount, groupSize = 5, pool = CATEGORIES.english.concat(CATEGORIES.numbers)) {
  const groups = [];
  for (let i = 0; i < groupCount; i++) {
    groups.push(randomChars(groupSize, pool));
  }
  return groups.join(" ");
}
